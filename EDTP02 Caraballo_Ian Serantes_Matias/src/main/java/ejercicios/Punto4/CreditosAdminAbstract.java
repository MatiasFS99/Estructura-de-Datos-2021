...
public abstract class CreditosAdminAbstract {
    ...
    /**
     * Devuelve todos los cr�ditos otorgados a los clientes cuyo tipo es pasado
     * por par�metro
     *
     * @param tipo
     * @return
     ...
     * @return
     */
    public abstract List<Credito> creditosPorCreditoTipoySucursal(ClienteTipoEnum tipo, Sucursal sucursal);

    /**
     * Devuelve los cr�ditos cuyo monto es inferior a monto.
     *
     * @param monto
     * @return
     */
